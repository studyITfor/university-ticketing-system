    ...
    initializeSocket() {
        try {
            ...
            this.socket.on('update-seat-status', (data) => {
                ...
                } else if (data.type === 'seat-status-update') {
                    console.log('📡 Seat status update received:', data.seatId, 'Status:', data.status);
                }
                ...
                // Always refresh admin data to show latest changes
                this.loadBookings();
                this.updateStatistics();
                this.generateHallPreview();
                this.renderPrebookedTable();
                ...
                console.log('✅ Admin panel data refreshed after real-time update');
            });
            ...
            this.socket.on('admin:heartbeat-ack', (data) => {
                console.log('💓 Admin heartbeat acknowledged:', data);
            });
